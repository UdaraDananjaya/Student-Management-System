...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <li class="nav-item $View_Department">
            <a class="nav-link" href="View_Department">
        ...
        <li class="nav-item $View_Program">
            <a class="nav-link" href="View_Program">
                <i class="fas fa-fw fa-graduation-cap"></i>
                <span>View Program</span></a>
        </li>
        ...
        <li class="nav-item $View_Class">
            <a class="nav-link" href="View_Class">
                <i class="fas fa-fw fa-users"></i>
                <span>View Class</span></a>
        </li>
        ...
        <li class="nav-item $View_Lecturer">
            <a class="nav-link" href="View_Lecturer">
                <i class="fas fa-fw fa-user-tie"></i>
                <span>View Lecturer</span></a>
        </li>
