...
if (isset($_GET['EditId'])) { 
    $sql = "SELECT * FROM `user` WHERE user_id = {$_GET['EditId']};";
...
if (isset($_POST['submit'])) { 
    ...
    $sql = "UPDATE `user` SET `user_name` = '{$_POST['uname']}',`email` = '{$_POST['email']}' $sql_pass ,`user_type` = '{$_POST['usergroup']}',`mobile` = '{$_POST['mobile']}' WHERE `user_id` = '{$_GET['EditId']}'";
    $conn->query($sql);
...
<h1 class="h3 mb-4 text-gray-800">Update Lecturer</h1>
<div class="col-md-8 mx-auto">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-center" Style="color:#58cfbb;">Update Lecturer</h6>
        </div>
        <div class="card-body">
            <form method="post">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-from-label">User Type : ({$row['user_type']}) </label>
                    <div class="col-md-8">
                        <div class="form-group">
                ...
                <a class="btn btn-warning" href="Manage_Lecturer"> Cancel </a>
                <input class="btn btn-primary" name="submit" type="submit" value="Update Lecturer">
            </form>
        </div>
    </div>
</div>
